...
/***/ "./assets/src/common/InjectedElements.js"
/*!***********************************************!*\
  !*** ./assets/src/common/InjectedElements.js ***!
  \***********************************************/
...
var InjectedElements = /*#__PURE__*/function () {
  function InjectedElements() {
    _classCallCheck(this, InjectedElements);
  }
  return _createClass(InjectedElements, null, [{
    key: "remove",
    value: function () {
      var _remove = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var injectedElements, injectedStyles, temp;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              // Remove html elements
              injectedElements = document.querySelectorAll('.endora-panel');
              if (injectedElements) {
                document.querySelectorAll('.endora-panel').forEach(function (el) {
                  return el.remove();
                });
              }
              ...
              if (injectedStyles) {
                injectedStyles.forEach(function (style) {
                  if (style.textContent.includes('.endora-panel')) {
                    style.remove();
                  }
                });
              }
              ...
              // Remove comments
              setTimeout(function () {
                var iterator = document.createNodeIterator(document.head, NodeFilter.SHOW_COMMENT);
                var node;
                while (node = iterator.nextNode()) {
                  if (node.nodeValue.includes('injected banner')) {
                    node.remove();
                    break; // stop after first match
                  }
                }
                var iterator2 = document.createNodeIterator(document.body, NodeFilter.SHOW_COMMENT);
                var node2;
                while (node2 = iterator2.nextNode()) {
                  if (node2.nodeValue.includes('end banner')) {
                    node2.remove();
                    break; // stop after first match
                  }
                }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InjectedElements);

/***/ },

/***/ "./assets/src/common/ThemeLoader.js"
/*!******************************************!*\
  !*** ./assets/src/common/ThemeLoader.js ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var ThemeLoader = /*#__PURE__*/function () {
  function ThemeLoader() {
    ...
    // custom buttons behavior
    if (document.querySelectorAll(this._selectors.btn)) {
      document.querySelectorAll(this._selectors.btn).forEach(function (element) {
        element.addEventListener("focus", _this._onBtnClick.bind(_this));
        element.addEventListener("active", _this._onBtnClick.bind(_this));
      });
    }

    // color scheme
    document.querySelector(this._selectors.themeLight).addEventListener("click", this._onLightTheme.bind(this));
    document.querySelector(this._selectors.themeDark).addEventListener("click", this._onDarkTheme.bind(this));
  ...
  return _createClass(ThemeLoader, [{
    ...
    get: function get() {
      return {
        btn: ".js-btn-custom",
        themeLight: ".js-theme-light",
        themeDark: ".js-theme-dark"
      };
    }
  }, {
    key: "_onBtnClick",
    ...
    key: "_setColorScheme",
    value: function _setColorScheme() {
      var preferredColorScheme = window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches ? "dark" : "light";
      var colorScheme = localStorage.getItem("theme");
      if (null === colorScheme) {
        if ("dark" === preferredColorScheme) {
          document.querySelector(this._selectors.themeDark).click();
        } else {
          document.querySelector(this._selectors.themeLight).click();
        }
      } else {
    ...
    key: "_onLightTheme",
    value: function _onLightTheme(e) {
      if (e.currentTarget.classList.contains("active")) {
        return;
      }
      document.querySelector(this._selectors.themeLight).classList.add("active");
      document.querySelector(this._selectors.themeDark).classList.remove("active");
      this._setTheme("light");
    }
  }, {
    key: "_onDarkTheme",
    value: function _onDarkTheme(e) {
      if (e.currentTarget.classList.contains("active")) {
        return;
      }
      document.querySelector(this._selectors.themeLight).classList.remove("active");
      document.querySelector(this._selectors.themeDark).classList.add("active");
      this._setTheme("dark");
    }
  }, {
    key: "_setTheme",
...
/* harmony import */ var _src_common_ThemeLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/common/ThemeLoader */ "./assets/src/common/ThemeLoader.js");
/* harmony import */ var _src_common_InjectedElements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/common/InjectedElements */ "./assets/src/common/InjectedElements.js");





if (!window._3f8rc0x586eet346) {
  window._3f8rc0x586eet346 = true;
